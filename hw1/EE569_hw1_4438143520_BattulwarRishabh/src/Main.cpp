...
void usage(const char *exename)
{
	...
	std::cout << "\t -sigma : (default) 1\n" 	<< std::endl;
	std::cout << "\t -sigma_sim : (default) 20\n" 	<< std::endl;
	std::cout << "\t -rs : (default) 5\n" 	<< std::endl;
	std::cout << "\t -thresh : (default) 20.0\n" 	<< std::endl;
	std::cout << "\t -iter : (default) 5\n" 	<< std::endl;
	std::cout << "\t -infile : (default) ../images/mandril.raw\n" 	<< std::endl;
	std::cout << "\t -outfile : (default) ../images/mandril_bw.raw\n" 	<< std::endl;
	exit(1);
}
